...
public class Profile extends AppCompatActivity {
    ...
    //1. CREATE AN ACTION LINKED TO THE FORWARDING BUTTON (to show more details on post)
    //-> setOnClickListener is listening if button is ever clicked. If it is, all the actions in this function run.
        forward_button = (ImageView) findViewById(R.id.imageForwardButton);
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(Profile.this, "Details of Post", Toast.LENGTH_SHORT).show();

            //Links the action of pressing button = going to next layout.
            Intent intent = new Intent(Profile.this, ShowDetailedPostScreen.class);
    ...
    // ************************************* MENU BUTTON FUNCTIONALITIES BELOW **************************************** //
        ...
        home_button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                //TODO: CAN REMOVE THIS AFTER EVERYTHING WORKS CORRECTLY
                //specifies what class its in, what the text says, how long the text will be there, and if we should show it or not.
                Toast.makeText(Profile.this, "Going to Home Page", Toast.LENGTH_SHORT).show();
        ...
        search_button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                //TODO: CAN REMOVE THIS AFTER EVERYTHING WORKS CORRECTLY
                //specifies what class its in, what the text says, how long the text will be there, and if we should show it or not.
                Toast.makeText(Profile.this, "Going to Search Page", Toast.LENGTH_SHORT).show();
        ...
        predictions_button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                //TODO: CAN REMOVE THIS AFTER EVERYTHING WORKS CORRECTLY
                //specifies what class its in, what the text says, how long the text will be there, and if we should show it or not.
                Toast.makeText(Profile.this, "Going to Predictions Page", Toast.LENGTH_SHORT).show();

                //Links the action of pressing button = going to next layout.
                Intent intent = new Intent(Profile.this, Predictions.class);
        ...
        notification_button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                //TODO: CAN REMOVE THIS AFTER EVERYTHING WORKS CORRECTLY
                //specifies what class its in, what the text says, how long the text will be there, and if we should show it or not.
                Toast.makeText(Profile.this, "Going to Notifications Page", Toast.LENGTH_SHORT).show();
